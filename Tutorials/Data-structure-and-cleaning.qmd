---
title: "2. Data structure and cleaning - Using Tidyverse"
author: "Hyun Koo"
---
...
## 1. Working with vectors and data types in R
...
### 2.1 Install Tidyverse and read mtcars data
...
### 2.3 Data cleaning: select, filter, mutate, arrange, summarize functions
...
## Practice: Working with HDSinRdata
...
1) Work with vectors, data frames, and objects
2) Convert between data types
3) Use pipe operators for readable code
4) Clean and summarize real-world datasets
