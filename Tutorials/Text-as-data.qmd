---
title: "6. Text as data: Basic textual analysis"
author: "G.H. Koo"
---
...
We will learn how to preprocess text data, remove noise, and analyze patterns in language.

```{r, eval=FALSE}
packages <- c("tidytext", "tokenizers", "wordcloud", "textdata", "RColorBrewer", "htmltools")
...
:::callout-tip
The dataset is stored in the "data" folder of this project. Using relative file paths ensures the code runs on any computer.
:::
...
```{r}
YT_data <- data[, c("channelTitle", "title", "description", "publishedAt", "video_id")]
```
...
:::callout-note
Use 'head(YT_tokenized_cleaned$word, 20)' to display the cleaned words with stopwords removed. 
:::
...
For example, to find words that appear with “president,” we tokenize the text into bigrams using unnest_tokens(), split each bigram into two words, and filter for pairs that include “president” Counting the accompanying words shows which terms most often co-occur with “president,” helping us see how the term is described or used in context.
