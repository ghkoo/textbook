...
When writing code in your Rmarkdown, make sure:
> every ```{r} needs another ```

If the r is missing after the opening backticks, R will treat the code as plain text and it will not run. This is a very common beginner mistake, especially when getting started.
:::